                 ...
                 Text copyText = Texts.bracketed(
                     Text.literal("Copy Coords")
                         .fillStyle(Style.EMPTY
                             ...
                             .withClickEvent(ClickEvent.of(ClickEvent.Action.COPY_TO_CLIPBOARD, coords))
                             .withHoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, Text.literal("Click to copy all coordinates")))
